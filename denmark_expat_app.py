...
def load_data():
    ...
    data = [
        ...
        {'location': 'Roskilde', 'recommendation': '3b', 'program': 'Roskilde Festival', 'organization': 'Festival Organization', 'status': 'Active'},
